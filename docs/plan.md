...
D8. DECIDED (owner, 2026-09-15): every `.php` written in this repository -- fixtures, any part of
    ...
    an exempted directory is gone or has grown a `bench/`, so the list cannot rot. 364 `.php`
