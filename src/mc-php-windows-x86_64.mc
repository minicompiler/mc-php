// mc-php-windows-x86_64.mc -- the compiler hosted on windows/x86_64.
//
...
// and an import library (tests/winsys.sh builds them; src/mc-php.windows-x86_64.toml
...
//
//   sh tests/winsys.sh x86_64 && mc build src --config src/mc-php.windows-x86_64.toml
#include <mc/host_windows_x86_64>
#include <mc/core>
