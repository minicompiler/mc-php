...
| [`awaitable.src.php`](awaitable.src.php) | the PHP source that should one day compile into that extension, carrying the `#[Extern]` attribute shape. It is the target of the LANGUAGE, not of any milestone that has landed. |
